...
See [`STORE_LISTING.md`](./STORE_LISTING.md) for ready-to-paste short/long descriptions, category suggestions, and permission justifications for the review process.
...
参考 [`STORE_LISTING.md`](./STORE_LISTING.md)，其中包含可直接粘贴使用的简短/详细描述、分类建议，以及审核时需要的权限说明话术。

### 许可证

MIT（或替换为你偏好的许可证，发布前请更新此部分）。
